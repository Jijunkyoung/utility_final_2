...
<div class="settings-layout">
  <section class="card intranet-card">
    <p class="eyebrow">외부 사이트 차단 환경</p>
    <h2>사내망 대시보드 접속</h2>
    <p class="sub">GitHub Pages나 chatgpt.site에 접속하지 않고, 승인된 사내 PC 한 대가 화면과 데이터를 함께 제공합니다.</p>
    <ol class="intranet-steps">
      <li><b>서버 PC 준비</b><span>전체 프로젝트 폴더를 회사에서 허용한 방법으로 서버 PC에 복사합니다.</span></li>
      <li><b>설정 파일 작성</b><span><code>server/config.local.json</code>에 32자 이상 접근 토큰과 공유폴더 경로를 입력합니다.</span></li>
      <li><b>사내 서버 실행</b><span><code>server/start_server_lan.bat</code>를 실행하고 창에 표시된 접속 주소를 확인합니다.</span></li>
      <li><b>다른 PC 접속</b><span>같은 사내망 PC에서 <code>http://서버PC-IP:8765</code>를 엽니다.</span></li>
    </ol>
    <div class="intranet-state" id="intranet-state"></div>
    <div class="security-note">보안프로그램을 우회하거나 방화벽을 임의로 끄지 않습니다. 회사 IT 담당자에게 서버 PC의 <b>TCP 8765 인바운드</b>를 필요한 사내망 범위에만 허용해 달라고 요청하세요.</div>
  </section>
