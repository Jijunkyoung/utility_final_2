...
<div class="card">
  ...
  <form id="eq-form" class="grid-form">
    ...
    <label>건물 <input name="building" placeholder="본관" list="bldg-list"><datalist id="bldg-list"></datalist></label>
	    ...
	    <label>제조사 <input name="manufacturer" placeholder="제조사"></label>
	    <label>모델 <input name="model" placeholder="모델명"></label>
	    <label>사양 <input name="spec" placeholder="15인승 / 1.0 m/s / 11.5 kW"></label>
	    <label>용량 <input name="capacity" placeholder="1.5 t/h / 300 RT"></label>
    ...
    <label>소모전력 <input name="power" placeholder="11.5 kW"></label>
	    ...
	    <label>설치일 <input name="installedAt" type="date"></label>
    ...
    <label>법령 확인일 <input name="lawCheckedAt" type="date"></label>
	    <label style="grid-column:1/-1">비고 <input name="note" placeholder="운전 조건, 특이사항 등"></label>
  </form>
  <div id="law-hint"></div>
  <div class="btnrow">
